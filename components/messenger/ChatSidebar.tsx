      ...
      <aside className={`w-full md:w-80 border-r border-white/10 flex flex-col bg-surface-dark/50 shrink-0 ${className}`}>
        <div className="p-4 flex flex-col gap-4">
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => setIsModalOpen(true)} className="size-8 bg-accent-neon/10 text-accent-neon rounded-lg flex items-center justify-center hover:bg-accent-neon/20 transition-all">
          ...
          <div className="flex bg-background-dark/50 p-1 rounded-xl border border-white/5">
            <button
              ...
              className={`flex-1 py-2 text-xs font-bold uppercase tracking-wider rounded-lg transition-all ${activeTab === 'PRIVATE'
            ...
            <button
              ...
              className={`flex-1 py-2 text-xs font-bold uppercase tracking-wider rounded-lg transition-all ${activeTab === 'GROUP'
                  ? 'bg-accent-neon text-black shadow-neon-glow'
                  : 'text-slate-500 hover:text-slate-300'
                }`}
            >
